...
if (isset($_POST["enviar"])){
    ...
    if ($nombre==null){
        ...
        header("Location:nominas.php?token=".$_SESSION["token"]);
    }else if ($puesto=="Sindicalista"){
        $_SESSION["salmed"]=salario_medio($trabajadores);
        $_SESSION["nombre"]=$nombre;
        $_SESSION["trabajadores"]=$trabajadores;

        header("Location:sindicalista.php?token=".$_SESSION["token"]);
        ...
        $_SESSION["nombre"]=$nombre;
        $_SESSION["trabajadores"]=$trabajadores;
        header("Location:gerente.php?token=".$_SESSION["token"]);
